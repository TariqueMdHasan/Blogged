...
import MyPBlogs from "../UserProfile/UserBlogs";
import MyPAnalytics from "../UserProfile/UserAnalytics";
import MyPComments from "../UserProfile/UserComment";
...
function UserProfile() {
    ...
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://blogbackend-wi2j.onrender.com/api/outh/user/${userId}`
        );
  ...
  const renderComponent = () => {
    switch (active) {
      case "MyPBlogs":
        return <MyPBlogs userId={userId} />;
      case "MyPComments":
        return <MyPComments userId={userId} />;
      case "MyPAnalytics":
        return <MyPAnalytics userId={userId} />;
      default:
        return <MyPBlogs userId={userId} />;
    }
  };
  ...
  return (
    <div className="MyProfile">
        ...
        <div className="MyProfile-information-container">
          ...
          {userPd === user._id ? (
            <button
              ...
              className="MyProfile-information-Edit-button"
            >
              <FaUserEdit />
              Edit Profile
            </button>
      ...
      <div className="MyProfile-blogs-nav-container">
        ...
        <div className="MyProfile-blogs-AllData">{renderComponent()}</div>
      </div>
    </div>
  );
}
